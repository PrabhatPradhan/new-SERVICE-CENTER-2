...
const CardItem = ({ Icon, label, title, description }) => (
  <div className="cursor-pointer bg-white border border-gray-200 rounded-xl p-6 flex flex-col justify-between shadow-md hover:shadow-2xl hover:scale-[1.03] hover:-translate-y-1 transform transition-all duration-300 ease-in-out relative h-full">
    ...
    <p className="text-xs sm:text-sm md:text-base text-gray-600 mb-6 leading-relaxed line-clamp-3 h-[72px]">
      {description}
    </p>
  ...
  const cardData = [
    {
      ...
      label: "Feature One",
      title: "REFRIGERATOR",
      description: "Quick and reliable repair for your refrigerator, including gas refill, compressor issue, and cooling problems.",
    ...
    },
    {
      ...
      description: "Professional repair for all types of washing machines: front load, top load, and semi-automatic.",
    ...
    },
    {
      ...
      description: "AC installation, servicing, and gas refill solutions at the best price with quick turnaround.",
    ...
    },
    {
      ...
      description: "Fix heating issues, glass rotation problems, or any internal faults in your microwave oven.",
    ...
    },
    {
      ...
      label: "Feature Five",
      title: "TELEVISION",
      description: "Screen issues, sound problems, or motherboard repairs for your LED or LCD TVs.",
    ...
    },
    {
      ...
      label: "Feature Six",
      title: "GEYSER",
      description: "Electric and gas geyser servicing, including heating coil replacement and leakage fix.",
    ...
    },
    {
      ...
      description: "Filter change, water flow issues, and complete RO system servicing at home.",
    ...
    },
    {
      ...
      description: "Chimney cleaning, suction motor repair, and installation service by experts.",
